...
if [ "$(whoami)" != "root" ]; then
    ...
    # Make
    export CC="clang"
    export CFLAGS="-ferror-limit=1 -ggdb3 -gdwarf-4 -O0 -std=c11 -Wall -Werror -Wextra -Wno-gnu-folding-constant -Wno-sign-compare -Wno-unused-parameter -Wno-unused-variable -Wshadow"
